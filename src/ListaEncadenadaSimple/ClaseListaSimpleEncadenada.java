...
public class ClaseListaSimpleEncadenada {

    public Nodo prim;
    public Nodo ult;
    public int cantElem;

    public ClaseListaSimpleEncadenada() {
        prim = ult = null;
    }
...
//7mo L1.eliminarIesimo(i) : Método que elimina el i-ésimo elemento de la lista L1.
    ...
    public void insertarLista2enL1(ClaseListaSimpleEncadenada L2) {
        ult.prox = L2.prim;
        ult = L2.ult;
...
//    41. L1.eliminarTodo (x )
//
//    : Método que elimina todos los elementos x de la lista L1.
    ...
    public static void main(String[] args) {
        ClaseListaSimpleEncadenada l1 = new ClaseListaSimpleEncadenada();
        l1.insertarUlt(4);
        l1.insertarUlt(5);
        l1.insertarUlt(9);
        l1.insertarUlt(7);
        ...
        ClaseListaSimpleEncadenada L2 = new ClaseListaSimpleEncadenada();
        L2.insertarUlt(3);
        L2.insertarUlt(3);
        L2.insertarUlt(3);
